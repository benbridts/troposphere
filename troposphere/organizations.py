...
class Root(AWSObject):
    """
    `Root <http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-organizations-root.html>`__
    """

    resource_type = "AWS::Organizations::Root"

    props: PropsDictType = {}


class PolicyTypeSummary(AWSProperty):
    """
    `PolicyTypeSummary <http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-organizations-root-policytypesummary.html>`__
    """
